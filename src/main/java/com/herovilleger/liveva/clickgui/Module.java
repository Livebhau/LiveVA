...
import com.herovilleger.liveva.clickgui.components.PlainLabel;
...
public class Module extends FlowLayout {
    ...
    public Module(String name, Feature feature, String tooltip, Settings options) {
        ...
        this.label.horizontalTextAlignment(HorizontalAlignment.LEFT)
                .verticalTextAlignment(VerticalAlignment.CENTER)
                .margins(Insets.of(3, 2, 5, 5));
    ...
    public boolean onMouseDown(Click click, boolean doubled) {
        if (click.y() <= (double) this.label.fullSize().height()) {
            if (click.button() == GLFW.GLFW_MOUSE_BUTTON_1) {
                ...
                net.minecraft.client.MinecraftClient.getInstance().setScreen(this.options);
            }
            return true;
        }
        return false;
